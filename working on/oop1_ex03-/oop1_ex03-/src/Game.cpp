...
Game::Game() : window(sf::VideoMode(1360, 900), "Cat & Mouse Game") {
    ...
    emptyTexture.loadFromFile("empty_texture.png");
...
//            switch (tile) {
//            case '#': 
//                    sprite.setTexture(textures[0]); break; // Wall
//            case '^':
//                     sprite.setTexture(textures[1]); break; // Cat
//            case '*':
//                    sprite.setTexture(textures[2]); break; // Cheese
//            case '$': 
//                     sprite.setTexture(textures[3]); break; // Gift
//            case 'F': 
//                     sprite.setTexture(textures[4]); break; // Key
//            case 'D':  
//                     sprite.setTexture(textures[5]); break; // Door
//            case '%': 
//                    sprite.setTexture(textures[6]); break; // Mouse                   
...
void Game::moveCharacter(char direction) {
    // Adjust the movement logic based on keyboard input
    Location newPos = mouse.getPosition();
    switch (direction) {
    case 'w':
        newPos.row--; // Move up
        break;
    case 's':
        newPos.row++; // Move down
        break;
    case 'a':
        newPos.col--; // Move left
        break;
    case 'd':
        newPos.col++; // Move right
        break;
    default:
        break;
    }
